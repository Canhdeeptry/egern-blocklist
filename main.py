...
# URL của file TXT
TXT_URL = 'https://github.com/bigdargon/hostsVN/blob/master/filters/adservers-all.txt'  # Thay thế với URL của bạn
...
def convert_txt_to_yml():
    ...
    domain_suffix_set = [line.strip() for line in lines if line.strip()]
